...
class _ListadoAparatosPageState extends State<ListadoAparatosPage> {
  ...
  Widget _buildAparato(
      BuildContext context, Usuario usuario, DocumentSnapshot aparato) {
    return Padding(
                ...
                body: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (BuildContext abContext,
                    ...
                    if (aSnapshot.hasData && aSnapshot.data != null) {
                      List<Widget> aees = aSnapshot.data.documents
                          .map((DocumentSnapshot aparato) =>
                              _buildAparato(abContext, uSnapshot.data, aparato))
                          .toList();
                  ...
                  onPressed: () async {
                    if (this._numeroSeguimiento == null) {
                      ...
                      bool guardar = await Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ConteoPage(
                                  usuario: uSnapshot.data,
                                  numeroManifiesto: this._numeroSeguimiento,
