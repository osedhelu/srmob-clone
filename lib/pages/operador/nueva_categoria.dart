          ...
          child: ListView(          
            ...
            children: <Widget>[
              ...
              RaisedButton(
                ...
                child: AutoSizeText("Enviar solicitud", style: Theme.of(context).textTheme.display1.copyWith(color: Colors.white),), 
                onPressed: () async {   
                  ...
                  await Firestore.instance.collection("solicitudes")
                    .document().setData(
                      {
                        "nombre": this._nombre,
                  ...
                  var message = "Se ha envíado su solicitud de adición de nuevo RAEE";                    
              ...
              RaisedButton(
                ...
                child: AutoSizeText("Cancelar", style: Theme.of(context).textTheme.display1.copyWith(color: Colors.white),), 
                onPressed: () {
