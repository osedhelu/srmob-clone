...
class _ListadoMuestrasState extends State<ListadoMuestrasPage> {
  ...
  void initState() {
    ...
    Query query = analisis
        .where("conteo", isEqualTo: this.widget.conteo)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: this.muestras.isEmpty
            ? Center(
                child: Text("Cargando muestras"),
              )
            : GridView.extent(
                shrinkWrap: true,
                ...
                children: muestras
                    .map((DocumentSnapshot muestra) =>
                        _buildMuestra(context, muestra))
                    .toList(),
              ));
  }
}
