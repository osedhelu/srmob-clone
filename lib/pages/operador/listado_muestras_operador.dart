...
class ListadoMuestrasOperadorPage extends StatefulWidget{    
  ...
  ListadoMuestrasOperadorPage({Key key, this.usuario, this.fechaSeleccionada, this.selectedIndex}) : super(key: key);

  @override
  State<ListadoMuestrasOperadorPage> createState() => new _ListadoMuestrasOperadorPageState();

}

class _ListadoMuestrasOperadorPageState extends State<ListadoMuestrasOperadorPage>{
  ...
  @override
  void initState(){    
    this._bottomSelectedIndex = this.widget.selectedIndex != null ? this.widget.selectedIndex : this._bottomSelectedIndex;
    super.initState();
  }
