...
class RevisarSolicitudPage extends StatefulWidget{
  ...
  RevisarSolicitudPage({Key key, this.usuario, this.solicitud}) : super(key: key);
    ...
    return showDialog<bool>(
      ...
      builder: (BuildContext dContext){
        return StatefulBuilder(
            builder: (sbContext, setState2) {
              return AlertDialog(
                title: Text("Rechazar solicitud", style: Theme.of(sbContext).textTheme.headline,),
                content: Form(
                  key: _formKey2,
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: Theme.of(sbContext).textTheme.body1,
                      ...
                      /*OutlineLabel(
                        ...
                        padding: 2.5,
                        child: */FutureBuilder(
                          future: Firestore.instance.collection("aparato").orderBy("nombre").getDocuments(),
                          builder: (BuildContext abContext, AsyncSnapshot<QuerySnapshot> aSnapshot) {
                            if( aSnapshot.hasData && aSnapshot.data != null ){
                              return DropdownButtonFormField<String>(                 
                                  ...
                                  items: aSnapshot.data.documents.map(
                                      (DocumentSnapshot aparato){
                                        return DropdownMenuItem<String>(
                                          value: aparato.data["nombre"],
                                          child: Text( aparato.data["nombre"], ),
                                        );
                                      }
                                    ).toList(),
                                  validator: (value){
                ...
                actions: <Widget>[
                  RaisedButton(
                    child: Text("Rechazar", style: Theme.of(sbContext).textTheme.button,),
                    onPressed: () {
                  ...
                  RaisedButton(
                    ...
                    child: Text("Cancelar", style: Theme.of(sbContext).textTheme.button,),
                    onPressed: (){
          ...
          child: ListView(          
            ...
            children: <Widget>[
              ...
              RaisedButton(
                ...
                child: AutoSizeText("Aceptar solicitud", style: Theme.of(context).textTheme.display1.copyWith(color: Colors.white),), 
                onPressed: () async {   
                  ...
                  await Firestore.instance.collection("aparato")
                    .document()
                    .setData(
                      {
                        "codigo": this._codigo,
                  ...
                  var message = "Se ha aceptado la solicitud de adición de nuevo raee";                    
              ...
              RaisedButton(
                ...
                child: AutoSizeText("Rechazar", style: Theme.of(context).textTheme.display1.copyWith(color: Colors.white),), 
                onPressed: () async {                    
                  if( await _showRejectDialog(context) ){
                    ...
                    var message = "Se ha rechazado la solicitud de adición de nuevo raee";                    
                    Navigator.of(context).pop(message);  
                  }                                  
                },                    
              ),
