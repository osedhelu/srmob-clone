...
class ListadoMuestrasPage extends StatefulWidget{    
  ...
  ListadoMuestrasPage({Key key, this.usuario, this.gestor, this.fechaSeleccionada, this.selectedIndex}) : super(key: key);
                ...
                builder: (BuildContext abContext, AsyncSnapshot<QuerySnapshot> aSnapshot) {                  
                  if( aSnapshot.hasData && aSnapshot.data != null ){ 
                    ...
                    if( this.widget.fechaSeleccionada == null ){
                      ...
                      childrens = aSnapshot.data.documents.map((DocumentSnapshot analisis) => _buildMuestra(abContext, analisis)).toList();
                    }                 
