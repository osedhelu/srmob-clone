...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        key: _scaffoldKey,
        appBar: AppBar(title: Text("Smart RAEE")),
        body: Form(
          key: _formKey,
          child: ListView(
            padding:
            ...
            children: <Widget>[
              ...
              StatefulRaisedButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate()) {
                    ...
                    securityBloc.login(username, password).catchError((error) {
                      print("Error... $error");
              ...
              FutureBuilder<String>(
                  ...
                  builder: (BuildContext cvContext,
                      AsyncSnapshot<String> cvSnapshot) {
                    if (cvSnapshot.hasData && cvSnapshot.data != null) {
                      return Text(
                        "Version: ${cvSnapshot.data}",
